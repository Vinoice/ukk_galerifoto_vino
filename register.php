...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container">
    <a class="navbar-brand" href="index.php">Website Galeri
        <link rel="stylesheet" href="assets/style.css" class="rel">Foto</a>
            ...
            <div class="card">
                <div class="card-body bg-light">
                    ...
                    <form action="config/aksi_register.php" method="POST">
                        ...
                        <label class="from-label">namalengkap</label>
                        <input type="text" name="namalengkap" class="form-control" required>
                        <label class="from-label">alamat</label>
                        <input type="text" name="alamat" class="form-control" required>
                        <div class="d-grid mt-2">
                            <button class="btn btn-dark" type="sumbit" name="kirim">Daftar
                            </button>
                        </div>
                    </form>
                    <hr>
