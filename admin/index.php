            ...
            <div class="card mb-3">
              ...
              <div class="card-footer text-center">
                ...
                if (mysqli_num_rows($ceksuka) == 1) { ?>
                  <a href="../config/proses_like.php?fotoid=<?php echo $data['fotoid'] ?>"><i class="fa fa-heart"></i></a>
                <?php } else { ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="overflow-auto p-3">
                        ...
                        <p><span class="badge bg-secondary"><?php echo $data['namalengkap'] ?></span> <span class="badge bg-secondary"><?php echo $data['tanggalunggah'] ?></span> <span class="badge bg-primary"><?php echo $data['namaalbum'] ?></span></p>
                        ...
                        <?php } ?>
                        <form action="../config/proses_komentar.php" method="POST" class="mt-3">
