                    ...
                    <div class="card">
                        ...
                        <div class="card-footer text-center">
                            ...
                            if (mysqli_num_rows($ceksuka) == 1) { ?>
                                <a href="../config/proses_like_user.php?fotoid=<?php echo $data['fotoid'] ?>"><i class="fa fa-heart text-danger"></i></a>
                            <?php } else { ?>
                                ...
                                <div class="overflow-auto p-3">
                                    ...
                                    while ($comment = mysqli_fetch_array($comments)) { ?>
                                        <div class="comment mb-2">
                                            ...
                                            <form action="../config/proses_hapus_komentar_user.php" method="post" class="d-inline">
